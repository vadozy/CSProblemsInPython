...
class Graph(Generic[V, E]):
    def __init__(self, vertices: List[V] = None) -> None:
        ...
        self._edges: List[List[E]] = [[] for _ in vertices]
    ...
    def add_edge(self, edge: E) -> None:
        ...
        self._edges[edge.v].append(cast(E, edge.reversed()))

    # Add an edge using vertex indices (convenience method)
    def add_edge_by_indices(self, u: int, v: int) -> None:
        edge: E = cast(E, Edge(u, v))
        self.add_edge(edge)
    ...
    # Lookup a vertex index and find its neighbors (convenience method)
    def neighbors_for_vertex(self, vertex: V) -> List[V]:
        return self.neighbors_for_index(self.index_of(vertex))

    # Return all of the edges associated with a vertex at some index
    def edges_for_index(self, index: int) -> List[E]:
        return self._edges[index]

    # Lookup the index of a vertex and return its edges (convenience method)
    def edges_for_vertex(self, vertex: V) -> List[E]:
...
if __name__ == "__main__":
    ...
    city_graph: Graph[str, Edge] = Graph(
